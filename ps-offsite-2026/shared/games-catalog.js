...
export const GAMES = {
  ...
  HD: { name: 'Hidden Document', emoji: '📄', kind: 'manual', rules: 'A document has been hidden deep inside Google Drive, buried under decoy folders, misleading versions, and forgotten files.\n\nSome files are distractions.\nSome versions lie.\nOnly one holds the real thing.\n\nDon\'t search blindly — follow the trail.\n\nAt the end:\n\n- Complete the assignment hidden inside the document.\n- Send evidence of completion to Jan Ciupa via DM.\n\nRules:\n\n- Use any tools, methods, or technology you like.\n- Clues arrive throughout the day — check the app regularly.\n- Decoy files and misleading versions exist.\n- Do NOT delete, rename, move, or modify any files you find to be connected to this game.' },
